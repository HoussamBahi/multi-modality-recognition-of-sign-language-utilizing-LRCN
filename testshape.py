...
# print(n)
# for i in range(n):
#     tface.append(x_face[2])
# tface = np.asarray(tface, dtype = np.float32)
#
#
# print("tface",tface.shape)
...
h=(x_face.shape[2],x_face.shape[3])

f=(x_gait.shape[2],x_gait.shape[3])
#[x_face, x_gait]
history = model.fit([(x_face[2],x_face[3]), (x_gait[2],x_gait[3])], y, batch_size = BATCH_SIZE, epochs = EPOCHS, validation_split = VALID_SPLIT)
